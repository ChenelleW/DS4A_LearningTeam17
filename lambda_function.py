...
def lambda_handler(event, context):
    ...
    try:
        ...
        if e.response['Error']['Code'] == "404":
            url='https://docs.google.com/spreadsheets/d/e/2PACX-1vRnnfmFPBi2UJUAhkbEH9vdST88xBOr9L8KNdv40WzUPyMuEU9770BYVtjyOqDbBnhPmeqkhAbAWzdw/pub?output=csv'
...
def upload_Redshift(rs_table,bucket_name,file,DELIMITER,REGION):
    ...
    copy_query = "COPY "+rs_table+" from 's3://"+ bucket_name+'/'+file+"' iam_role 'arn:aws:iam::397410343504:role/service-role/AmazonRedshift-CommandsAccessRole-20230707T202818' delimiter "+DELIMITER+" IGNOREHEADER 1 REGION " + REGION
